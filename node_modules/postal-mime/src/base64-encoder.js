...
// Creamos el transporte usando SMTP oficial de Gmail
const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: process.env.EMAIL_USER,         // tatianacani19@gmail.com
        pass: process.env.GMAIL_APP_PASSWORD  // cxmvsvmtwyluzwte
    }
});

export const sendResetEmail = async (email, token) => {
    try {
        console.log("[EMAIL] Iniciando envío de correo vía Nodemailer (Gmail SMTP)...");
        ...
        const mailOptions = {
            ...
            to: recipientEmail, // 👈 Ahora SI enviará a felipeherrerahernandez30@gmail.com o a cualquier otro
        ...
        console.log("[EMAIL] ¡Correo enviado con éxito vía Nodemailer! ID:", info.messageId);
        return info;

    } catch (error) {
        console.error("[EMAIL] FALLO al enviar el correo vía Nodemailer:", error.message);
        throw error;
    }
};
